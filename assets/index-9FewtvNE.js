(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))c(t);new MutationObserver(t=>{for(const a of t)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&c(o)}).observe(document,{childList:!0,subtree:!0});function r(t){const a={};return t.integrity&&(a.integrity=t.integrity),t.referrerPolicy&&(a.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?a.credentials="include":t.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function c(t){if(t.ep)return;t.ep=!0;const a=r(t);fetch(t.href,a)}})();const d="/logo/82_logo.png",g="/hero/hero_00.jpg",u="/hero/hero_01.jpg",p="/hero/hero_02.jpg",v="/hero/hero_03.jpg",m="/hero/hero_04.jpg",y="/hero/hero_05.jpg",b="/hero/hero_06.jpg",f="/gallery/menchikatsu.jpg",k="/gallery/steak.jpg",$="/gallery/variety.jpg",w="/gallery/cozy.jpg",S={ja:{nav:{about:"お店について",gallery:"ギャラリー",contact:"アクセス"},hero:{subtitle:"Niku no Hani Shokudou",tagline:"懐かしくて新しい大衆酒場"},about:{title:"お店について",text:`目白駅スグ、提灯に誘われ階段を上がると「あのドア」がお出迎え！<br><br>
...
A nostalgic yet modern izakaya where you can recharge your energy any day of the week♪`},gallery:{title:"Gallery",items:["Signature Menchikatsu","Famous Hamburger Steak","Variety of Dishes","Cozy Atmosphere"]},contact:{title:"Visit Us",location:{title:"Location",address:"3-13-23 Mejiro, Toshima-ku, Tokyo, Happyaku Store 2F",detail:"Right by Mejiro Station!"},hours:{title:"Hours",lunch:"Lunch 11:30～17:00",dinner:"Dinner 17:00〜23:00",lastorder:"L.O. Food 22:00 / Drinks 22:30",closed:"Irregular holidays"},phone:{title:"Phone",number:"03-6908-2313"},payment:{title:"Payment Methods",cards:"Cards (VISA, Master, JCB, AMEX, Diners)",emoney:"E-money (Suica, iD, QUICPay)",qr:"QR Payment (PayPay, d払い, au PAY)"},instagram:"Instagram",tabelog:"Tabelog",googleMaps:"Google Maps"},footer:"© 2024 肉の八十二食堂 (Niku no Hani Shokudou). All rights reserved."}};let i="ja";function h(){const e=S[i];document.querySelector("#app").innerHTML=`
  ...
  <section class="hero">
    <div class="hero-slideshow">
      <div class="hero-slide active" style="background-image: url('${g}')"></div>
      <div class="hero-slide" style="background-image: url('${u}')"></div>
      <div class="hero-slide" style="background-image: url('${p}')"></div>
      <div class="hero-slide" style="background-image: url('${v}')"></div>
      <div class="hero-slide" style="background-image: url('${m}')"></div>
      <div class="hero-slide" style="background-image: url('${y}')"></div>
      <div class="hero-slide" style="background-image: url('${b}')"></div>
    </div>
    <div class="hero-overlay"></div>
    <div class="hero-content">
      <img src="${d}" alt="Logo" class="hero-logo" />
    ...
    <div class="container">
      ...
      <div class="gallery-grid">
        <div class="gallery-item">
          <div class="placeholder-img"><img src="${f}" alt="Menchikatsu" /></div>
          <p>${e.gallery.items[0]}</p>
        </div>
        <div class="gallery-item">
          <div class="placeholder-img"><img src="${k}" alt="Steak" /></div>
          <p>${e.gallery.items[1]}</p>
        </div>
        <div class="gallery-item">
          <div class="placeholder-img"><img src="${$}" alt="Variety" /></div>
          <p>${e.gallery.items[2]}</p>
        </div>
        <div class="gallery-item">
          <div class="placeholder-img"><img src="${w}" alt="Cozy" /></div>
...
`,L()}function L(){const e=document.getElementById("langToggle");e&&e.addEventListener("click",()=>{i=i==="ja"?"en":"ja",h()}),document.querySelectorAll('a[href^="#"]').forEach(o=>{o.addEventListener("click",function(l){l.preventDefault();const n=document.querySelector(this.getAttribute("href"));n&&n.scrollIntoView({behavior:"smooth",block:"start"})})});const s={threshold:.1,rootMargin:"0px 0px -50px 0px"},r=new IntersectionObserver(o=>{o.forEach(l=>{l.isIntersecting&&l.target.classList.add("fade-in-visible")})},s);setTimeout(()=>{document.querySelectorAll(".about, .gallery-item, .contact-card, .social-link").forEach(o=>{o.classList.add("fade-in"),r.observe(o)})},100);const c=document.querySelectorAll(".hero-slide");let t=0;function a(){c[t].classList.remove("active"),t=(t+1)%c.length,c[t].classList.add("active")}setInterval(a,4e3)}h();
